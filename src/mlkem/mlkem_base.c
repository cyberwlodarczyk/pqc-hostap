...
#undef CRYPTO_LEN_SECRET_KEY
#undef CRYPTO_SYMBYTES
#undef MLKEM1024_LEN_SHARED_SECRET
#undef MLKEM1024_LEN_CIPHERTEXT
#undef MLKEM1024_LEN_PUBLIC_KEY
#undef MLKEM1024_LEN_SECRET_KEY
#undef MLKEM1024_SYMBYTES
#undef MLKEM512_LEN_SHARED_SECRET
#undef MLKEM512_LEN_CIPHERTEXT
#undef MLKEM512_LEN_PUBLIC_KEY
#undef MLKEM512_LEN_SECRET_KEY
#undef MLKEM512_SYMBYTES
#undef MLKEM768_LEN_SHARED_SECRET
#undef MLKEM768_LEN_CIPHERTEXT
#undef MLKEM768_LEN_PUBLIC_KEY
#undef MLKEM768_LEN_SECRET_KEY
#undef MLKEM768_SYMBYTES
#undef MLKEM_LEN_SHARED_SECRET
#undef MLKEM_LEN_CIPHERTEXT
#undef MLKEM_LEN_CIPHERTEXT_
#undef MLKEM_LEN_PUBLIC_KEY
#undef MLKEM_LEN_PUBLIC_KEY_
#undef MLKEM_LEN_SECRET_KEY
#undef MLKEM_LEN_SECRET_KEY_
...
#undef MLK_TEMPO_NAMESPACE_PREFIX
...
#undef MLKEM_ETA1
#undef MLKEM_ETA2
#undef MLKEM_INDCCA_LEN_CIPHERTEXT
#undef MLKEM_INDCCA_LEN_PUBLIC_KEY
#undef MLKEM_INDCCA_LEN_SECRET_KEY
#undef MLKEM_INDCPA_BYTES
#undef MLKEM_INDCPA_MSGBYTES
#undef MLKEM_INDCPA_LEN_PUBLIC_KEY
#undef MLKEM_INDCPA_LEN_SECRET_KEY
#undef MLKEM_K
#undef MLKEM_N
