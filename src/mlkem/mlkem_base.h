...
#define TEMPO512_LEN_REQ 848
#define TEMPO512_LEN_RES TEMPO512_LEN_CIPHERTEXT
...
#define TEMPO768_LEN_REQ 1256
#define TEMPO768_LEN_RES TEMPO768_LEN_CIPHERTEXT
...
#define TEMPO1024_LEN_REQ 1664
#define TEMPO1024_LEN_RES TEMPO1024_LEN_CIPHERTEXT
...
#define TEMPO_LEN_MASTER_KEY_ID 16
...
#define TEMPO_LEN_REQ_(LVL) TEMPO##LVL##_LEN_REQ
#define TEMPO_LEN_RES_(LVL) TEMPO##LVL##_LEN_RES
...
#define TEMPO_LEN_REQ(LVL) TEMPO_LEN_REQ_(LVL)
#define TEMPO_LEN_RES(LVL) TEMPO_LEN_RES_(LVL)
...
extern "C"
{
    ...
    int MLK_API_TEMPO_NAMESPACE(keygen)(
        uint8_t req[TEMPO_LEN_REQ(MLK_CONFIG_API_PARAMETER_SET)],
    ...
    MLK_API_QUALIFIER
    MLK_API_MUST_CHECK_RETURN_VALUE
    int MLK_API_TEMPO_NAMESPACE(check_req)(
        const uint8_t req[TEMPO_LEN_REQ(MLK_CONFIG_API_PARAMETER_SET)]);

    MLK_API_QUALIFIER
    MLK_API_MUST_CHECK_RETURN_VALUE
    int MLK_API_TEMPO_NAMESPACE(encaps)(
        uint8_t res[TEMPO_LEN_RES(MLK_CONFIG_API_PARAMETER_SET)],
        uint8_t pk[TEMPO_LEN_PUBLIC_KEY(MLK_CONFIG_API_PARAMETER_SET)],
    ...
    int MLK_API_TEMPO_NAMESPACE(decaps)(
        ...
        const uint8_t res[TEMPO_LEN_RES(MLK_CONFIG_API_PARAMETER_SET)]);
    ...
    int MLK_API_TEMPO_NAMESPACE(finish)(
        ...
        uint8_t mkid[TEMPO_LEN_MASTER_KEY_ID],
        const uint8_t pk[TEMPO_LEN_PUBLIC_KEY(MLK_CONFIG_API_PARAMETER_SET)],
        const uint8_t req[TEMPO_LEN_REQ(MLK_CONFIG_API_PARAMETER_SET)],
        const uint8_t res[TEMPO_LEN_RES(MLK_CONFIG_API_PARAMETER_SET)],
        const uint8_t ss[TEMPO_LEN_SHARED_SECRET],
