...
#define MLKEM_INDCPA_LEN_PUBLIC_KEY (MLKEM_POLYVECBYTES + MLKEM_SYMBYTES)
#define MLKEM_INDCPA_LEN_SECRET_KEY (MLKEM_POLYVECBYTES)
#define MLKEM_INDCPA_BYTES \
    (MLKEM_POLYVECCOMPRESSEDBYTES_DU + MLKEM_POLYCOMPRESSEDBYTES_DV)

#define MLKEM_INDCCA_LEN_PUBLIC_KEY (MLKEM_INDCPA_LEN_PUBLIC_KEY)
/* 32 bytes of additional space to save H(pk) */
#define MLKEM_INDCCA_LEN_SECRET_KEY                              \
    (MLKEM_INDCPA_LEN_SECRET_KEY + MLKEM_INDCPA_LEN_PUBLIC_KEY + \
     2 * MLKEM_SYMBYTES)
#define MLKEM_INDCCA_LEN_CIPHERTEXT (MLKEM_INDCPA_BYTES)

#define TEMPO_LAMBDA (8 * MLKEM_K)
#define TEMPO_3LAMBDA (3 * TEMPO_LAMBDA)
#define TEMPO_LEN_TAG (2 * TEMPO_LAMBDA)
#define TEMPO_LEN_APK (TEMPO_3LAMBDA + \
                       MLKEM_POLYVECBYTES + MLKEM_SYMBYTES)
#define TEMPO_LEN_REQ TEMPO_LEN_APK
#define TEMPO_LEN_RES MLKEM_INDCCA_LEN_CIPHERTEXT
